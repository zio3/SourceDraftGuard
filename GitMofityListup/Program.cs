...
var repoPath = @"C:\Users\info\Source\Repos\zio3\MyFunctions\"; // Gitリポジトリのパス
var files = GetUnpushedAndTrackedFiles(repoPath);

foreach (var file in files)
{
    Console.WriteLine(file);
}
string[] GetUnpushedAndTrackedFiles(string repoPath)
{
